...
# Optimize time
# We set each single cell as the initial cell state, while randomly
# permuting time values for all the other cells. (10 runs). We then
# select the cell with the minimal loss function value as the initial
# cell
